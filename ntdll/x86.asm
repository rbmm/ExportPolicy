...
API _NtAllocateUuids@16
API _NtAllocateVirtualMemory@24
API _NtAllocateVirtualMemoryEx@28
API _ZwAlpcAcceptConnectPort@36
API _NtAlpcCancelMessage@12
API _NtAlpcConnectPort@44
API _ZwAlpcConnectPortEx@44
API _NtAlpcCreatePort@12
API _ZwAlpcCreatePortSection@24
API _NtAlpcCreateResourceReserve@16
API _ZwAlpcCreateSectionView@12
API _ZwAlpcCreateSecurityContext@12
API _ZwAlpcDeletePortSection@12
API _ZwAlpcDeleteResourceReserve@12
API _NtAlpcDeleteSectionView@12
API _ZwAlpcDeleteSecurityContext@12
API _ZwAlpcDisconnectPort@8
API _ZwAlpcImpersonateClientContainerOfPort@12
API _ZwAlpcImpersonateClientOfPort@12
API _ZwAlpcOpenSenderProcess@24
API _NtAlpcOpenSenderThread@24
API _ZwAlpcQueryInformation@20
API _NtAlpcQueryInformationMessage@24
API _ZwAlpcRevokeSecurityContext@12
API _NtAlpcSendWaitReceivePort@32
API _ZwAlpcSetInformation@16
API _NtApphelpCacheControl@8
API _NtAreMappedFilesTheSame@8
API _NtAssignProcessToJobObject@8
API _NtAssociateWaitCompletionPacket@32
API _NtCallEnclave@16
API _NtCallbackReturn@12
API _ZwCancelIoFile@8
API _ZwCancelIoFileEx@12
API _ZwCancelSynchronousIoFile@12
API _ZwCancelTimer@8
API _NtCancelTimer2@8
API _NtCancelWaitCompletionPacket@8
API _ZwChangeProcessState@24
API _ZwChangeThreadState@24
API _ZwClearEvent@4
API _NtClose@4
API _NtCloseObjectAuditAlarm@12
API _NtCommitComplete@8
API _ZwCommitEnlistment@8
API _NtCommitRegistryTransaction@8
API _ZwCommitTransaction@8
API _NtCompactKeys@8
API _ZwCompareObjects@8
API _ZwCompareSigningLevels@8
API _ZwCompareTokens@12
API _NtCompleteConnectPort@4
API _ZwCompressKey@4
API _ZwConnectPort@32
API _NtContinue@8
API _NtContinueEx@8
API _NtConvertBetweenAuxiliaryCounterAndPerformanceCounter@16
API _ZwCopyFileChunk@40
API _ZwCreateCpuPartition@20
API _NtCreateCrossVmEvent@24
API _ZwCreateCrossVmMutant@24
API _ZwCreateDebugObject@16
API _ZwCreateDirectoryObject@12
API _ZwCreateDirectoryObjectEx@20
API _ZwCreateEnclave@36
API _NtCreateEnlistment@32
API _NtCreateEvent@20
API _NtCreateEventPair@12
API _NtCreateFile@44
API _NtCreateIRTimer@12
API _ZwCreateIoCompletion@16
API _ZwCreateIoRing@20
API _NtCreateJobObject@12
API _ZwCreateJobSet@12
API _ZwCreateKey@28
API _NtCreateKeyTransacted@32
API _ZwCreateKeyedEvent@16
API _ZwCreateLowBoxToken@36
API _ZwCreateMailslotFile@32
API _ZwCreateMutant@16
API _NtCreateNamedPipeFile@56
API _NtCreatePagingFile@16
API _NtCreatePartition@16
API _NtCreatePort@20
API _ZwCreatePrivateNamespace@16
API _ZwCreateProcess@32
API _ZwCreateProcessEx@36
API _NtCreateProcessStateChange@20
API _NtCreateProfile@36
API _ZwCreateProfileEx@40
API _NtCreateRegistryTransaction@16
API _NtCreateResourceManager@28
API _NtCreateSection@28
API _NtCreateSectionEx@36
API _ZwCreateSemaphore@20
API _NtCreateSymbolicLinkObject@16
API _ZwCreateThread@32
API _ZwCreateThreadEx@44
API _NtCreateThreadStateChange@20
API _NtCreateTimer@16
API _NtCreateTimer2@20
API _NtCreateToken@52
API _NtCreateTokenEx@68
API _NtCreateTransaction@40
API _NtCreateTransactionManager@24
API _NtCreateUserProcess@44
API _ZwCreateWaitCompletionPacket@12
API _ZwCreateWaitablePort@20
API _ZwCreateWnfStateName@28
API _NtCreateWorkerFactory@40
API _NtdllNtCurrentTeb@0
API _NtDebugActiveProcess@8
API _ZwDebugContinue@12
API _ZwDelayExecution@8
API _ZwDeleteAtom@4
API _ZwDeleteBootEntry@4
API _NtDeleteDriverEntry@4
API _ZwDeleteFile@4
API _NtDeleteKey@4
API _ZwDeleteObjectAuditAlarm@12
API _NtDeletePrivateNamespace@4
API _ZwDeleteValueKey@8
API _NtDeleteWnfStateData@8
API _ZwDeleteWnfStateName@4
API _ZwDeviceIoControlFile@40
API _NtDirectGraphicsCall@20
API _NtDisableLastKnownGood@0
API _NtDisplayString@4
API _ZwDrawText@4
API _NtDuplicateObject@28
API _NtDuplicateToken@24
API _ZwEnableLastKnownGood@0
API _NtEnumerateBootEntries@8
API _ZwEnumerateDriverEntries@8
API _NtEnumerateKey@24
API _ZwEnumerateSystemEnvironmentValuesEx@12
API _NtEnumerateTransactionObject@20
API _ZwEnumerateValueKey@24
API _ZwExtendSection@8
API _NtFilterBootOption@20
API _NtFilterToken@24
API _NtFilterTokenEx@56
API _ZwFindAtom@12
API _ZwFlushBuffersFile@8
API _NtFlushBuffersFileEx@20
API _ZwFlushInstallUILanguage@8
API _NtFlushInstructionCache@12
API _NtFlushKey@4
API _ZwFlushProcessWriteBuffers@0
API _ZwFlushVirtualMemory@16
API _NtFlushWriteBuffer@0
API _NtFreeUserPhysicalPages@12
API _NtFreeVirtualMemory@16
API _ZwFreezeRegistry@4
API _NtFreezeTransactions@8
...
API _ZwGetDevicePowerState@8
API _NtGetMUIRegistryInfo@12
API _NtGetNextProcess@20
API _NtGetNextThread@24
API _NtGetNlsSectionPtr@20
API _ZwGetNotificationResourceManager@28
API _NtGetTickCount_syscall_thunk@0
API _ZwGetWriteWatch@28
API _ZwImpersonateAnonymousToken@4
API _NtImpersonateClientOfPort@8
API _NtImpersonateThread@12
API _NtInitializeEnclave@20
API _NtInitializeNlsFiles@12
API _NtInitializeRegistry@4
API _ZwInitiatePowerAction@16
API _ZwIsProcessInJob@8
API _NtIsSystemResumeAutomatic@0
...
API _ZwLoadKeyEx@32
API _ZwLockFile@40
API _NtLockProductActivationKeys@8
API _NtLockRegistryKey@4
API _ZwLockVirtualMemory@16
API _NtMakePermanentObject@4
API _NtMakeTemporaryObject@4
API _NtManageHotPatch@16
API _NtManagePartition@20
API _ZwMapCMFModule@24
API _NtMapUserPhysicalPages@12
API _ZwMapUserPhysicalPagesScatter@12
API _ZwMapViewOfSection@40
API _NtMapViewOfSectionEx@36
API _ZwModifyBootEntry@4
API _ZwModifyDriverEntry@4
API _NtNotifyChangeDirectoryFile@36
API _NtNotifyChangeDirectoryFileEx@40
API _ZwNotifyChangeKey@40
API _NtNotifyChangeMultipleKeys@48
API _NtNotifyChangeSession@32
API _NtOpenCpuPartition@12
API _NtOpenDirectoryObject@12
API _NtOpenEnlistment@20
API _ZwOpenEvent@12
API _ZwOpenEventPair@12
API _NtOpenFile@24
...
API _ZwOpenKeyedEvent@12
API _NtOpenMutant@12
API _NtOpenObjectAuditAlarm@48
API _ZwOpenPartition@12
API _ZwOpenPrivateNamespace@16
API _NtOpenProcess@16
API _ZwOpenProcessToken@12
API _ZwOpenProcessTokenEx@16
API _NtOpenRegistryTransaction@12
API _NtOpenResourceManager@20
API _NtOpenSection@12
API _NtOpenSemaphore@12
API _NtOpenSession@12
API _ZwOpenSymbolicLinkObject@12
API _NtOpenThread@16
API _ZwOpenThreadToken@16
API _NtOpenThreadTokenEx@20
API _ZwOpenTimer@12
API _NtOpenTransaction@20
API _ZwOpenTransactionManager@24
API _NtPlugPlayControl@12
API _ZwPowerInformation@20
API _ZwPrePrepareComplete@8
API _NtPrePrepareEnlistment@8
API _ZwPrepareComplete@8
API _ZwPrepareEnlistment@8
API _NtPrivilegeCheck@12
API _ZwPrivilegeObjectAuditAlarm@24
API _ZwPrivilegedServiceAuditAlarm@20
API _NtPropagationComplete@16
API _ZwPropagationFailed@12
API _NtProtectVirtualMemory@20
API _ZwPssCaptureVaSpaceBulk@20
API _ZwPulseEvent@8
API _NtQueryAttributesFile@8
API _ZwQueryAuxiliaryCounterFrequency@4
API _NtQueryBootEntryOrder@8
API _NtQueryBootOptions@8
API _ZwQueryDebugFilterState@8
API _NtQueryDefaultLocale@8
API _ZwQueryDefaultUILanguage@4
API _ZwQueryDirectoryFile@44
API _NtQueryDirectoryFileEx@40
API _ZwQueryDirectoryObject@28
API _ZwQueryDriverEntryOrder@8
API _ZwQueryEaFile@36
API _NtQueryEvent@20
API _ZwQueryFullAttributesFile@8
API _ZwQueryInformationAtom@20
API _NtQueryInformationByName@20
API _NtQueryInformationCpuPartition@20
API _ZwQueryInformationEnlistment@20
API _NtQueryInformationFile@20
API _NtQueryInformationJobObject@20
API _NtQueryInformationPort@20
API _ZwQueryInformationProcess@20
API _ZwQueryInformationResourceManager@20
API _ZwQueryInformationThread@20
API _ZwQueryInformationToken@20
API _ZwQueryInformationTransaction@20
API _ZwQueryInformationTransactionManager@20
API _ZwQueryInformationWorkerFactory@20
API _ZwQueryInstallUILanguage@4
API _NtQueryIntervalProfile@8
API _NtQueryIoCompletion@20
API _NtQueryIoRingCapabilities@8
API _ZwQueryKey@20
API _ZwQueryLicenseValue@20
API _NtQueryMultipleValueKey@24
API _NtQueryMutant@20
API _ZwQueryObject@20
API _ZwQueryOpenSubKeys@8
API _NtQueryOpenSubKeysEx@16
API _NtQueryPerformanceCounter@8
API _NtQueryPortInformationProcess@0
API _ZwQueryQuotaInformationFile@36
API _NtQuerySection@20
API _ZwQuerySecurityAttributesToken@24
API _NtQuerySecurityObject@20
API _ZwQuerySecurityPolicy@24
API _ZwQuerySemaphore@20
API _ZwQuerySymbolicLinkObject@12
API _ZwQuerySystemEnvironmentValue@16
API _NtQuerySystemEnvironmentValueEx@20
API _ZwQuerySystemInformation@16
API _NtQuerySystemInformationEx@24
API _ZwQuerySystemTime@4
API _ZwQueryTimer@20
API _ZwQueryTimerResolution@12
API _NtQueryValueKey@24
...
API _NtRegisterProtocolAddressInformation@20
API _NtRegisterThreadTerminatePort@4
API _ZwReleaseKeyedEvent@16
API _NtReleaseMutant@8
API _ZwReleaseSemaphore@12
API _ZwReleaseWorkerFactoryWorker@4
API _NtRemoveIoCompletion@20
API _ZwRemoveIoCompletionEx@24
API _ZwRemoveProcessDebug@8
API _ZwRenameKey@8
API _ZwRenameTransactionManager@8
API _NtReplaceKey@12
API _ZwReplacePartitionUnit@12
API _NtReplyPort@8
API _ZwReplyWaitReceivePort@16
API _ZwReplyWaitReceivePortEx@20
API _ZwReplyWaitReplyPort@8
API _NtRequestPort@8
API _ZwRequestWaitReplyPort@12
API _ZwResetEvent@8
API _ZwResetWriteWatch@12
API _ZwRestoreKey@12
API _NtResumeProcess@4
API _ZwResumeThread@8
API _NtRevertContainerImpersonation@0
API _NtRollbackComplete@8
API _ZwRollbackEnlistment@8
API _NtRollbackRegistryTransaction@8
API _NtRollbackTransaction@8
API _ZwRollforwardTransactionManager@8
API _NtSaveKey@8
API _ZwSaveKeyEx@12
API _ZwSaveMergedKeys@12
API _ZwSecureConnectPort@36
API _NtSerializeBoot@0
API _ZwSetBootEntryOrder@8
API _NtSetBootOptions@8
API _ZwSetCachedSigningLevel@20
API _ZwSetCachedSigningLevel2@24
API _ZwSetContextThread@8
API _ZwSetDebugFilterState@12
...
API _ZwSetEaFile@16
API _NtSetEvent@8
API _ZwSetEventBoostPriority@4
API _NtSetEventEx@12
API _NtSetHighEventPair@4
API _NtSetHighWaitLowEventPair@4
API _NtSetIRTimer@8
API _NtSetInformationCpuPartition@28
API _NtSetInformationDebugObject@20
API _NtSetInformationEnlistment@16
API _NtSetInformationFile@20
API _ZwSetInformationIoRing@16
API _NtSetInformationJobObject@16
API _NtSetInformationKey@16
API _NtSetInformationObject@16
API _NtSetInformationProcess@16
API _ZwSetInformationResourceManager@16
API _ZwSetInformationSymbolicLink@16
API _NtSetInformationThread@16
API _NtSetInformationToken@16
API _NtSetInformationTransaction@16
API _ZwSetInformationTransactionManager@16
API _ZwSetInformationVirtualMemory@24
API _NtSetInformationWorkerFactory@16
API _NtSetIntervalProfile@8
API _ZwSetIoCompletion@20
API _ZwSetIoCompletionEx@24
API _ZwSetLdtEntries@24
API _NtSetLowEventPair@4
API _NtSetLowWaitHighEventPair@4
API _ZwSetQuotaInformationFile@16
API _ZwSetSecurityObject@12
API _NtSetSystemEnvironmentValue@8
API _ZwSetSystemEnvironmentValueEx@20
API _NtSetSystemInformation@12
API _ZwSetSystemPowerState@12
API _ZwSetSystemTime@8
API _NtSetThreadExecutionState@8
API _ZwSetTimer@28
API _NtSetTimer2@16
API _ZwSetTimerEx@16
API _NtSetTimerResolution@12
API _NtSetUuidSeed@4
API _NtSetValueKey@24
API _ZwSetVolumeInformationFile@20
API _NtSetWnfProcessNotificationEvent@4
API _NtShutdownSystem@4
API _NtShutdownWorkerFactory@8
...
API _NtSubscribeWnfStateChange@16
API _NtSuspendProcess@4
API _NtSuspendThread@8
API _NtSystemDebugControl@24
API _NtTerminateEnclave@8
API _ZwTerminateJobObject@8
API _ZwTerminateProcess@8
API _NtTerminateThread@8
API _NtTestAlert@0
API _NtThawRegistry@0
API _NtThawTransactions@0
API _NtTraceControl@24
API _ZwTraceEvent@16
API _ZwTranslateFilePath@16
...
API _NtWow64CsrClientConnectToServer@20
API _ZwWow64CsrFreeCaptureBuffer@4
API _ZwWow64CsrGetProcessId@0
API _NtWow64CsrIdentifyAlertableThread@0
API _NtWow64CsrVerifyRegion@8
API _NtWow64DebuggerCall@20
API _ZwWow64GetCurrentProcessorNumber@0
...
API _ZwWow64QueryInformationProcess64@20
API _NtWow64ReadVirtualMemory64@28
API _ZwWow64WriteVirtualMemory64@28
API _NtWriteFile@36
API _ZwWriteFileGather@36
API _NtWriteRequestData@24
API _ZwWriteVirtualMemory@20
API _NtYieldExecution@0
...
API _RtlConstructCrossVmEventPath@12
API _RtlConstructCrossVmEventPath@12
...
API _RtlDeleteBoundaryDescriptor@4
...
API _RtlFinalReleaseOutOfProcessMemoryStream@4
...
API _RtlGetCurrentThreadPrimaryGroup@0
...
API _RtlFinalReleaseOutOfProcessMemoryStream@4
API _RtlInitNlsTables@16
API _RtlFinalReleaseOutOfProcessMemoryStream@4
API _RtlInitString@8
API _RtlInitStringEx@8
...
API _RtlIsFeatureEnabledForEnterprise@4
...
API _RtlQueryAllInternalFeatureConfigurations@16
...
API _RtlRcuAllocate@4
API _RtlRcuFree@4
API @RtlRcuReadLock@8
API @RtlRcuReadUnlock@8
API _RtlRcuSynchronize@4
...
API _RtlValidateUserCallTarget@8
...
API _WinSqmSetIfMaxDWORD@12
API _RtlInitNlsTables@16
API _WinSqmAddToStreamEx@20
API _WinSqmCheckEscalationAddToStreamEx@20
API _WinSqmCheckEscalationSetDWORD@16
API _WinSqmCheckEscalationAddToStreamEx@20
API _WinSqmCheckEscalationSetDWORD@16
API _WinSqmCommonDatapointDelete@4
API _WinSqmCommonDatapointSetString@12
API _WinSqmSetEscalationInfo@16
