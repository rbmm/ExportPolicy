...
API _ActivateKeyboardLayoutStub@8
API _AddClipboardFormatListenerStub@4
API _NtUserAddVisualIdentifier@8
...
API _NtUserBeginPaint@8
API _NtUserBlockInput@4
...
API _NtUserCalcMenuBar@20
API _NtUserCalculatePopupWindowPosition@20
...
API _ChangeClipboardChainStub@8
...
API _NtUserChangeWindowMessageFilterEx@16
API _CharLowerAStub@4
API _CharLowerBuffAStub@8
API _CharLowerBuffWStub@8
API _CharLowerWStub@4
API _CharNextAStub@4
API _CharNextExAStub@12
API _CharNextWStub@4
API _CharPrevAStub@8
API _CharPrevExAStub@16
API _CharPrevWStub@8
API _CharToOemA@8
API _CharToOemBuffA@12
API _CharToOemBuffW@12
API _CharToOemW@8
API _CharUpperAStub@4
API _CharUpperBuffAStub@8
...
API _NtUserCheckProcessForClipboardAccess@8
API _NtUserCheckProcessSession@4
API _CheckRadioButton@16
API _NtUserCheckWindowThreadDesktop@8
API _ChildWindowFromPoint@12
API _NtUserChildWindowFromPointEx@16
API _CliImmSetHotKey@16
API _ClientThreadSetup@0
API _ClientToScreen@8
API _NtUserClipCursor@4
API _CloseClipboardStub@0
API _NtUserCloseDesktop@4
...
API _CopyImage@20
API _CopyRect@8
API _CountClipboardFormatsStub@0
API _CreateAcceleratorTableA@8
API _NtUserCreateAcceleratorTable@8
API _CreateCaretStub@16
API _CreateCursor@28
API _NtUserCreateDCompositionHwndTarget@12
...
API _NtUserDoSoundConnect@0
API _NtUserDoSoundDisconnect@0
API _NtUserDragDetect@12
API _NtUserDragObject@20
API _NtUserDrawAnimatedRects@16
API _DrawCaption@16
...
API _NtUserDwmGetRemoteSessionOcclusionEvent@0
API _NtUserDwmGetRemoteSessionOcclusionState@0
API _NtUserDwmKernelShutdown@0
...
API _NtUserEnableMouseInPointer@4
API _NtUserEnableNonClientDpiScaling@4
API _NtEnableOneCoreTransformMode@0
...
API _NtUserEnumDisplayMonitors@16
...
API _NtUserGetClipCursor@4
API _NtUserGetClipboardAccessToken@8
API _GetClipboardData@4
API _GetClipboardFormatNameA@12
API _GetClipboardFormatNameW@12
API _NtUserGetClipboardMetadata@8
API _GetClipboardOwnerStub@0
API _GetClipboardSequenceNumberStub@0
...
API _GetCursorPos@4
API _GetDC@4
API _NtUserGetDCEx@12
API _NtUserGetDCompositionHwndBitmap@8
API _NtUserGetDesktopID@8
API _GetCurrentThreadDesktopHwnd@0
API _GetDialogBaseUnits@0
API _GetDialogControlDpiChangeBehavior@4
API _GetDialogDpiChangeBehavior@4
API _NtUserGetDisplayAutoRotationPreferences@4
...
API _NtUserGetDoubleClickTime@0
...
API _NtUserGetKeyboardLayoutList@8
API _GetKeyboardLayoutNameA@4
API _GetKeyboardLayoutNameW@4
API _NtUserGetKeyboardState@4
API _GetKeyboardType@4
API _GetLastActivePopup@4
API _GetLastInputInfo@4
API _NtUserGetLayeredWindowAttributes@16
API _NtUserGetListBoxInfo@4
...
API _NtUserMagGetContextInformation@16
API _GetMenu@4
API _NtUserGetMenuBarInfo@16
...
API _NtUserGetMouseMovePointsEx@20
API _GetNextDlgGroupItem@12
API _GetNextDlgTabItem@12
API _GetOpenClipboardWindowStub@0
API _GetParent@4
API _GetCursorPos@4
API _NtUserGetPointerCursorId@8
API _NtUserGetPointerDevice@8
API _NtUserGetPointerDeviceCursors@12
API _NtUserGetPointerDeviceInputSpace@8
API _NtUserGetPointerDeviceOrientation@8
API _NtUserGetPointerDeviceProperties@12
API _NtUserGetPointerDeviceRects@12
API _NtUserGetPointerDevices@8
...
API _NtUserGetProcessUIContextInformation@8
API _NtUserGetProcessWindowStation@0
API _GetProgmanWindow@0
API _GetPropA@8
API _GetPropW@8
API _GetQueueStatus@4
API _GetRawInputBuffer@12
API _NtUserGetRawInputData@20
API _GetRawInputDeviceInfoA@16
API _GetRawInputDeviceInfoW@16
API _NtUserGetRawInputDeviceList@12
...
API _NtUserGetSystemDpiForProcess@4
API _NtUserGetSystemMenu@8
...
API _NtUserGhostWindowFromHungWindow@4
API _GrayStringA@36
API _GrayStringW@36
API _NtUserHandleDelegatedInput@8
API _HideCaretStub@4
API _NtUserHiliteMenuItem@16
API _NtUserHungWindowFromGhostWindow@4
API _IMPGetIMEA@8
API _IMPGetIMEW@8
API _IMPQueryIMEA@4
API _IMPQueryIMEW@4
API _IMPSetIMEA@8
API _IMPSetIMEW@8
API _NtUserImpersonateDdeClientWindow@8
API _InSendMessage@0
API _InSendMessageEx@4
API _InflateRect@12
API _NtUserInheritWindowMonitor@8
...
API _NtUserInjectKeyboardInput@8
API _NtUserInjectMouseInput@8
API _NtUserInjectPointerInput@12
API _NtUserInjectPointerInput@12
API _NtUserInjectTouchInput@8
API _NtInputSpaceRegionFromPoint@20
API _InsertMenuA@20
...
API _NtUserInvalidateRect@12
API _NtUserInvalidateRgn@12
API _InvertRect@8
API _IsCharAlphaAStub@4
API _IsCharAlphaNumericAStub@4
API _IsCharAlphaNumericWStub@4
API _IsCharAlphaWStub@4
API _IsCharLowerAStub@4
API _IsCharLowerWStub@4
API _IsCharUpperAStub@4
API _IsCharUpperWStub@4
API _IsChild@8
API _IsClipboardFormatAvailableStub@4
...
API _NtUserIsTopLevelWindow@4
API _NtUserIsTouchWindow@8
...
API _NtUserLockWindowStation@4
API _NtUserLockWindowUpdate@4
API _NtUserLockWorkStation@0
API _NtUserLogicalToPhysicalPoint@8
API _NtUserLogicalToPerMonitorDPIPhysicalPoint@8
...
API _PtInRect@12
API _NtUserQueryBSDRWindow@0
API _QueryDisplayConfig@24
API _NtUserQuerySendMessage@4
API _NtRIMAddInputObserver@32
API _NtRIMAreSiblingDevices@12
API _NtRIMDeviceIoControl@36
API _NtRIMEnableMonitorMappingForDevice@12
API _NtRIMFreeInputBuffer@8
API _NtRIMGetDevicePreparsedData@16
API _NtRIMGetDevicePreparsedDataLockfree@12
API _NtRIMGetDeviceProperties@12
API _NtRIMGetDevicePropertiesLockfree@8
API _NtRIMGetPhysicalDeviceRect@12
API _NtRIMGetSourceProcessId@12
API _NtRIMObserveNextInput@4
API _NtRIMOnAsyncPnpWorkNotification@4
API _NtRIMOnPnpNotification@4
API _NtRIMOnTimerNotification@4
API _NtRIMQueryDevicePath@8
API _NtRIMReadInput@28
API _RIMRegisterForInput@36
API _NtRIMRegisterForInputEx@40
API _NtRIMRemoveInputObserver@4
API _NtRIMSetExtendedDeviceProperty@12
...
API _NtUserRedrawWindow@16
API _NtUserRegisterBSDRWindow@8
...
API _NtUserRegisterErrorReportingDialog@8
API _NtUserRegisterForCustomDockTargets@4
API _NtUserRegisterForTooltipDismissNotification@8
API _RegisterFrostWindow@8
API _RegisterGhostWindow@8
API _NtUserRegisterHotKey@16
API _RegisterLogonProcess@8
API _RegisterMessagePumpHook@4
API _NtUserRegisterPointerDeviceNotifications@8
API _RegisterPointerInputTarget@8
API _RegisterPointerInputTargetEx@12
API _RegisterPowerSettingNotification@12
API _NtUserRegisterRawInputDevices@12
API _NtUserRegisterServicesProcess@4
API _NtUserRegisterSessionPort@4
...
API _ReleaseDC@8
API _NtUserReleaseDwmHitTestWaiters@0
API _RemoveClipboardFormatListenerStub@4
API _NtUserRemoveInjectionDevice@4
API _NtUserRemoveMenu@12
API _RemovePropA@8
API _RemovePropW@8
...
API _NtUserSetActiveWindow@4
API _NtUserSetAdditionalForegroundBoostProcesses@12
API _NtUserSetCapture@4
API _SetCaretBlinkTime@4
API _SetCaretPos@8
API _SetClassLongA@12
API _SetClassLongW@12
API _NtUserSetClassWord@12
...
API _NtUserSetDesktopColorTransform@4
API _NtUserSetDialogControlDpiChangeBehavior@12
API _SetDialogDpiChangeBehavior@12
API _NtUserSetDisplayAutoRotationPreferences@4
API _SetDisplayConfig@20
API _SetDlgItemInt@16
API _SetDlgItemTextA@12
API _SetDlgItemTextW@12
API _SetDoubleClickTime@4
API _NtUserSetFeatureReportResponse@12
API _NtUserSetFocus@4
API _NtUserSetForegroundRedirectionForActivationObject@8
API _SetForegroundWindow@4
API _NtUserSetFullscreenMagnifierOffsetsDWMUpdated@12
API _NtUserSetGestureConfig@20
API _NtUserSetInternalWindowPos@16
API _NtUserSetKeyboardState@4
API _SetLastErrorEx@8
API _NtUserSetLayeredWindowAttributes@16
API _SetMagnificationDesktopColorEffect@4
API _SetMagnificationDesktopMagnification@16
API _NtUserSetMagnificationDesktopMagnifierOffsetsDWMUpdated@4
API _SetMagnificationDesktopSamplingMode@4
API _NtUserMagSetContextInformation@16
API _SetMenu@8
API _NtUserSetMenuContextHelpId@8
API _NtUserSetMenuDefaultItem@12
API _SetMenuInfo@8
...
API _NtUserSetMirrorRendering@8
API _SetParentStub@8
API _NtUserSetCursorPos@8
API _NtSetPointerDeviceInputSpace@12
...
API _NtUserSetProcessLaunchForegroundPolicy@8
API _NtUserSetProcessRestrictionExemption@4
API _NtUserSetProcessWindowStation@4
...
API _NtUserSetWindowBand@12
API _SetWindowCompositionAttributeStub@8
API _NtUserSetWindowCompositionTransition@28
API _SetWindowContextHelpId@8
API _NtUserSetWindowDisplayAffinity@8
...
API _NtUserShowWindowAsync@8
API _ShutdownBlockReasonCreate@8
API _NtUserShutdownReasonDestroy@4
API _NtUserShutdownBlockReasonQuery@12
API _NtUserSignalRedirectionStartComplete@0
API _NtUserDiscardPointerFrameMessages@4
...
API _NtUserWaitForRedirectionStartComplete@0
API _NtUserWaitMessage@0
API _WinHelpA@16
API _WinHelpW@16
